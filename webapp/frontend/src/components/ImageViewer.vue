...
import { MagnifyingGlassPlusIcon, MagnifyingGlassMinusIcon, ArrowPathIcon } from '@heroicons/vue/24/outline'
...
<template>
  <div class="image-viewer relative flex flex-col items-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow w-full h-[80vh]">
    <!-- Toolbar -->
    <div class="w-full flex items-center justify-center p-3 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 rounded-t-lg shadow-sm gap-2 z-20">
    ...
    <!-- Image Container -->
    <div
      class="relative w-full flex-grow overflow-hidden bg-gray-200 dark:bg-gray-900 rounded-b-lg select-none touch-none"
      :class="cursorClass"
      @wheel="onWheel"
